...
export class OrderInfoService {
  ...
  // async getPersonOrders(personId: string): Promise<ApiOrder[]> {
  //   const personalOrders = await this.orderModel.find({ 
  //     personId,
  //     date: {
  ...
  //     }
  //   });
  //   const preparedOrder = personalOrders.map(async (order) => {
